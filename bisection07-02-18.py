...
def bisection(f, a, b, n): #f is the (continous and differentiable (at least on [a,b]) function, a is the lower bound of the range to search, b is the upper bound of the range to search, n is the number of itterations to bisect
  mid = (a + b) / 2
